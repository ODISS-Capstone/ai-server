...
For Qwen3.5 reasoning-engine data, runtime API/tool-use instructions belong
in the system message, while training examples include assistant
`<think>...</think>` longCOT blocks before tool calls and final answers.
