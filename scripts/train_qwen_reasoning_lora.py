...
For Qwen3.5 reasoning-engine data, reasoning and API/tool-use instructions
belong in the system message. Assistant messages should contain either
OpenAI-compatible tool calls or final user-facing answers.
