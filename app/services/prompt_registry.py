...
DEFAULT_PROMPTS: dict[str, dict[str, str]] = {
    "main_answer": {
        "system": (
            ...
            "- ODISS는 노년층뿐 아니라 중년 만성질환자와 꾸준한 복약 관리가 필요한 사용자를 함께 돕습니다.\n"
    ...
    "local_delivery": {
        "system": (
            ...
            "규칙:\n"
            "- 사용자 프로필에 이름이 있으면 '김영수님'처럼 이름으로 부르고, 없을 때만 '사용자님'이라고 부릅니다.\n"
            "- ODISS는 노년층뿐 아니라 중년 만성질환자와 꾸준한 복약 관리가 필요한 사용자도 사용합니다.\n"
            "- 검토 완료 문장에 없는 의학 정보를 새로 만들지 않습니다.\n"
            "- 가입, 프로필 회상, OCR 촬영/재촬영, 저장 확인, 알림 설정, 복용 기록은 데모 대화처럼 짧고 확실하게 말합니다.\n"
